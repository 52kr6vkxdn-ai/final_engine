...
`;
    ...
    if (!ace._zengineHighlightSets) {
        ace._zengineHighlightSets = {
            engine : new Set(["aiChat", "applyAngularImpulse", "applyForce", "applyGravity", "applyImpulse", "axisH", "axisV", "bounceX", "bounceY", "boundsClamp", "broadcast", "broadcastAll", "broadcastGroup", "cameraFollow", "cameraMoveTo", "cameraShake", "cameraUnfollow", "cancelRepeat", "chatPlayer", "chatSay", "cloneObject", "cloneSelf", "createJoystick", "currentAnimation", "currentScene", "currentSceneIndex", "destroy", "destroyAfter", "destroyAllJoysticks", "destroySelf", "distanceTo", "drawDebugCircle", "drawDebugLine", "drawText", "error", "fadeIn", "fadeOut", "find", "findAllInGroup", "findAllWithTag", "findWithTag", "fireProjectile", "flipX", "flipY", "getAmmo", "getCameraX", "getCameraY", "getCloneId", "getGroup", "getHealth", "getMaxAmmo", "getMaxHealth", "getObjectsInRadius", "getSceneName", "getState", "getTag", "getTime", "getTint", "getTouches", "getVelX", "getVelY", "getZOrder", "globalVar", "gotoScene", "heal", "hide", "hideChat", "hitFlash", "inRangeOf", "invincible", "isClone", "isDead", "isInvincible", "isKeyDown", "isKeyJustDown", "isKeyJustUp", "isOnCeiling", "isOnGround", "isOnWall", "isTouching", "isWalking", "knockback", "lockRotation", "log", "lookAt", "mouseDown", "mouseJustDown", "mouseX", "mouseY", "move", "moveForward", "moveTo", "objectShake", "offScreen", "onAmmoEmpty", "onBecomeHidden", "onBecomeVisible", "onCloneStart", "onCollisionEnter", "onCollisionExit", "onCollisionStay", "onDamage", "onDeath", "onDestroy", "onHeal", "onJump", "onKeyDown", "onKeyUp", "onLand", "onMessage", "onMouseClick", "onMouseEnter", "onMouseLeave", "onOverlapEnter", "onOverlapExit", "onPinch", "onReload", "onScreenEnter", "onScreenExit", "onStart", "onStateEnter", "onStateExit", "onStop", "onSwipe", "onTap", "onUpdate", "opts", "overlaps", "overlapsAllWithTag", "overlapsTag", "pauseScene", "playAnimation", "raycast", "raycastAll", "raycastFromSelf", "reload", "repeat", "restartScene", "resumeScene", "say", "sceneCount", "sceneSettings", "sceneVar", "screenMouseX", "screenMouseY", "screenToWorld", "sendMessage", "setAmmo", "setAngularVelocity", "setCollision", "setCollisionCategory", "setCollisionMask", "setGravity", "setGravityScale", "setGroup", "setHealth", "setImmovable", "setMaxAmmo", "setMaxHealth", "setPhysicsType", "setPhysicsVelocity", "setRotationLocked", "setSensor", "setState", "setTag", "setTint", "setVelocity", "setZOrder", "show", "showChat", "soundPlay", "soundStop", "soundStopAll", "spawnObject", "stopAnimation", "stopMovement", "stopWalking", "takeDamage", "think", "touchCount", "touchJustStarted", "trackTarget", "triggerJump", "tween", "unlockRotation", "velocityX", "velocityY", "forever", "cancelForever", "subevent", "wait", "walkTo", "walkToObject", "warn", "worldToScreen"]),
...
(function() {
    const _SB_ENGINE = new Set(["aiChat", "applyAngularImpulse", "applyForce", "applyGravity", "applyImpulse", "axisH", "axisV", "bounceX", "bounceY", "boundsClamp", "broadcast", "broadcastAll", "broadcastGroup", "cameraFollow", "cameraMoveTo", "cameraShake", "cameraUnfollow", "cancelRepeat", "chatPlayer", "chatSay", "cloneObject", "cloneSelf", "createJoystick", "currentAnimation", "currentScene", "currentSceneIndex", "destroy", "destroyAfter", "destroyAllJoysticks", "destroySelf", "distanceTo", "drawDebugCircle", "drawDebugLine", "drawText", "error", "fadeIn", "fadeOut", "find", "findAllInGroup", "findAllWithTag", "findWithTag", "fireProjectile", "flipX", "flipY", "getAmmo", "getCameraX", "getCameraY", "getCloneId", "getGroup", "getHealth", "getMaxAmmo", "getMaxHealth", "getObjectsInRadius", "getSceneName", "getState", "getTag", "getTime", "getTint", "getTouches", "getVelX", "getVelY", "getZOrder", "globalVar", "gotoScene", "heal", "hide", "hideChat", "hitFlash", "inRangeOf", "invincible", "isClone", "isDead", "isInvincible", "isKeyDown", "isKeyJustDown", "isKeyJustUp", "isOnCeiling", "isOnGround", "isOnWall", "isTouching", "isWalking", "knockback", "lockRotation", "log", "lookAt", "mouseDown", "mouseJustDown", "mouseX", "mouseY", "move", "moveForward", "moveTo", "objectShake", "offScreen", "onAmmoEmpty", "onBecomeHidden", "onBecomeVisible", "onCloneStart", "onCollisionEnter", "onCollisionExit", "onCollisionStay", "onDamage", "onDeath", "onDestroy", "onHeal", "onJump", "onKeyDown", "onKeyUp", "onLand", "onMessage", "onMouseClick", "onMouseEnter", "onMouseLeave", "onOverlapEnter", "onOverlapExit", "onPinch", "onReload", "onScreenEnter", "onScreenExit", "onStart", "onStateEnter", "onStateExit", "onStop", "onSwipe", "onTap", "onUpdate", "opts", "overlaps", "overlapsAllWithTag", "overlapsTag", "pauseScene", "playAnimation", "raycast", "raycastAll", "raycastFromSelf", "reload", "repeat", "restartScene", "resumeScene", "say", "sceneCount", "sceneSettings", "sceneVar", "screenMouseX", "screenMouseY", "screenToWorld", "sendMessage", "setAmmo", "setAngularVelocity", "setCollision", "setCollisionCategory", "setCollisionMask", "setGravity", "setGravityScale", "setGroup", "setHealth", "setImmovable", "setMaxAmmo", "setMaxHealth", "setPhysicsType", "setPhysicsVelocity", "setRotationLocked", "setSensor", "setState", "setTag", "setTint", "setVelocity", "setZOrder", "show", "showChat", "soundPlay", "soundStop", "soundStopAll", "spawnObject", "stopAnimation", "stopMovement", "stopWalking", "takeDamage", "think", "touchCount", "touchJustStarted", "trackTarget", "triggerJump", "tween", "unlockRotation", "velocityX", "velocityY", "wait", "walkTo", "walkToObject", "warn", "worldToScreen"]);
...
function _sidebarHTML() {
    const G = [
        ...
        ['Text (runtime)', [
            ...
            't.visible = false',
            't.destroy()',
            '// drawText is runtime-only — not visible in editor',
        ]],
        ['Input', [
            'isKeyDown("w")',
            'isKeyJustDown("Space")',
        ...
        ['Tween', [
            ...
            '// easeIn easeOut easeInOut elastic bounce steps4',
        ]],
        ['Timer', [
            'wait(seconds, fn)',
        ...
        ['Raycasting', [
            'raycast(x1, y1, x2, y2)',
            '// hits everything visible (incl. tilemaps + autotilemaps)',
            'raycast(x1, y1, x2, y2, "colliders")',
            '// "colliders" = only physics bodies + tilemaps (skips backgrounds)',
            'raycast(x1, y1, x2, y2, "wall")',
            '// any string = only objects/tilemaps with that tag',
            'raycastAll(x1, y1, x2, y2)',
            'raycastAll(x1, y1, x2, y2, "colliders")',
        ...
        ['Projectiles', [
            ...
            'fireProjectile("Bullet", 90, 15, { damage:1, lifetime:2 })',
            'fireProjectile("Bullet", 180, 10, { tag:"bullet", group:"playerBullets" })',
        ...
        ['Shooting (Gun)', [
            '// Attach Gun script to your sprite — it handles everything.',
            '// To fire manually from any script:',
            'fireProjectile("Bullet", 0, 20, { tag:"bullet", damage:1, lifetime:2 })',
            '// Aim at mouse:',
            'var angle = angleTo(getX(), getY(), mouseX(), mouseY())',
            'fireProjectile("Bullet", angle, 20, { tag:"bullet" })',
            '// Spawn manually with velocity:',
            'spawnObject("Bullet", getX(), getY(), (b) => { b.velocityX = 20; })',
        ]],
        ['Math', [
            'lerp(a, b, t)',
            'clamp(v, lo, hi)',
...
// ═══════════════════════════════════════════
//
//  Write your game logic inside the event
//  blocks below. Each block runs at a
//  different moment in the game.
//
//  Useful things you can do anywhere:
//    x += 1             move right
//    y += 1             move up
//    velocityX = 5      slide right automatically
//    setTag("player")   give this object a tag
//    log("hello")       print to console
//    wait(1, () => { }) run something after 1 sec
//    forever(() => { }) run something every frame
//
//  Find objects:
//    find("Boss")             by name
//    findWithTag("enemy")     by tag
//
//  Tip: comment things out with  //  to disable them.
// ═══════════════════════════════════════════
...
onStart(() => {
  ...
  // Examples (remove the // to enable):
  // velocityX = 3;                    // slide right
  // cameraFollow(find("${name}"), 6); // camera follows this
  // soundPlay("Music", { loop: true });
...
onUpdate((dt) => {
  ...
  // Multiply by dt for smooth frame-rate-independent movement.

  // Examples:
  // x += axisH() * 5 * dt;  // move with arrow keys / WASD
  // y += axisV() * 5 * dt;

});


// ── When this touches another object ─────────
onCollisionEnter((other) => {
  // other = the object you touched
  // other.name      → its label
  // other.hasTag("x") → true/false
  // other.destroy() → remove it
...
onMessage("hit", (data) => {
  // Someone called: sendMessage("${name.toLowerCase()}", "hit", data)
  log("hit received:", data);
});


// ── When this is spawned as a clone ──────────
onCloneStart(() => {
  // Runs on clones made by cloneSelf() — not on the original.
  // Great for giving each clone its own behaviour:
  ...
  // onScreenExit(() => {
  //   destroySelf();       // clean up off-screen clones
  // });
